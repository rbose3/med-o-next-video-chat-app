    ...
    <section className="bg-gray-950 text-white ">
        <div className="mx-auto max-w-screen-xl px-4 py-32 flex-col gap-24 flex h-screen items-center">
          ...
          <div className="mx-auto max-w-4xl text-center ">
            ...
            Our In-App Voice & Video chat application enables seamless one to one interactive voice & video chat directly with your consultant. Whether you&apos;re opting for your first session, evaluation of reports or monthly check-ups over the air it&apos;s an all in one solution.
            </p>
